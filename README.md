...
| ----------------------------- | :---------: | ----------------------------------------------------------------------------: |
| login              | click event |                      validation and redirect to social|
| search| type input |                               user profile displayed |
| logout           | click event | end of session and redirect to login page|
